...
class MainCategory(models.Model):
    ...
    title = models.CharField(max_length=64)
    sub_category = models.ForeignKey(SecondaryCategory,blank=True,null=True)
    id_focus = models.IntegerField(default=1)
...
class CategoryCata(models.Model):
    title = models.ForeignKey(MainCategory)
    sub_category = models.ForeignKey(SecondaryCategory)
    id_focus = models.IntegerField(default=1)
...
class Recipe(models.Model):
    ...
    category = models.ForeignKey(MainCategory,verbose_name='Κατηγορία')
    active = models.CharField(max_length=1,choices=STATUS, default='a',verbose_name='Κατάσταση')
...
class RecipeItem(models.Model):
    recipe = models.ForeignKey(Recipe, verbose_name='Συνταγή')
    recipe_part =models.CharField(max_length=64, verbose_name='Συστατικό')
    product = models.ForeignKey(Product, verbose_name='Προιόν ')
