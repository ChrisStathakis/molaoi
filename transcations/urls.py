...
urlpatterns = [
    ...
    url(r'^πάγια-έξοδα/προσωπικό/υπόλοιπο/(?P<dk>\d+)/$',view=pay_remaining),
    url(r'^πάγια-έξοδα/προσωπικό/υπόλοιπο/(?P<dk>\d+)/(?P<pk>\d+)/$',view=pay_remaining_id, name='pay_remaining_id'),
    url(r'^πάγια-έξοδα/προσωπικό/υπόλοιπο_/(?P<dk>\d+)/$',view=pay_remaining_id_, name='pay_remaining_id_'),
    ...
    url(r'^πάγια-έξοδα/επεξεργασία/(?P<dk>\d+)/(?P<pk>\d+)/$',view=pagia_exoda_edit_order),
     ...
     # vacations
    url(r'^vacation/$', VacationPage.as_view(), name='vacation'),
    url(r'^vacation/(?P<pk>\d+)/$', AddVacation.as_view(), name='add_vacation'),
    url(r'^vacation/edit/(?P<pk>\d+)/$', EditVacation.as_view(), name='vacation_edit'),
    url(r'^vacation/delete/(?P<pk>\d+)/$', view=vacation_delete, name='vacation_delete'),
    url(r'^vacation/update/(?P<pk>\d+)/$', view=vacation_update, name='vacation_update'),
