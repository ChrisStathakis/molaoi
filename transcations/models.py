...
class Person(models.Model):
    ...
    hour_salary_sum = models.DecimalField(max_digits=15,decimal_places=2,default=0,verbose_name='Υπόλοιπο Υπερωρίων')
    salary_paid = models.DecimalField(max_digits=20,decimal_places=2,default=0, verbose_name='Πιστωτικό Υπόλοιπο')
